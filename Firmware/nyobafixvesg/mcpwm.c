...
void mcpwm_adc_inj_int_handler(void) {
	...
	// =======================================================
	// HARDWARE PATCH: Fix Swapped Shunts and Inverted R53 Polarity
	// =======================================================
	
	// // 1. Correct the backwards differential routing on R53 (Channel 1)
	// curr1          = -curr1;
	// curr1_currsamp = -curr1_currsamp;
	// curr1_2        = -curr1_2;

	// 2. Swap Channel 0 and Channel 1 because R53 and R54 are cross-swapped
	// float tmp_curr = curr0;
	// curr0 = curr1;
	// curr1 = tmp_curr;

	// float tmp_samp = curr0_currsamp;
	// curr0_currsamp = curr1_currsamp;
	// curr1_currsamp = tmp_samp;
